...
function updateGating() {
  // P3 (« Idées suicidaires actives ») cotée Modéré/Présent déverrouille P4, P5, P6.
  // P2 est toujours accessible.
...
function computeScore() {
  ...
  // Formule pondérée — référence fixe (cf. matrice S.P.I.R.A.L.E.)
  var formulaEl = document.getElementById('sp-formula-detail');
  if (formulaEl) {
    formulaEl.textContent = 'Indice = (1.2S + 1.6P + 1.1I + 1.3A + 1.7L + 1.1E + 1.4R) / ' + MAX_RAW + ' × 100';
  }
...
var ITEM_LABELS = {
  ...
  sI1:"Entourage absent ou non disponible", sI2:"Qualité des liens dégradée ou inexistante",
