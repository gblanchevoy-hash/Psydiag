...
const PRES_TAB_COLORS = [
  {bg:'rgba(99,179,237,.12)', border:'rgba(99,179,237,.35)', text:'#63b3ed', icon:'👁'},  // Apparence
  {bg:'rgba(154,117,234,.12)', border:'rgba(154,117,234,.35)', text:'#9a75ea', icon:'🤝'}, // Contact
  {bg:'rgba(72,187,120,.12)', border:'rgba(72,187,120,.35)', text:'#48bb78', icon:'🗣'},   // Psychomotricité
  {bg:'rgba(246,173,85,.12)', border:'rgba(246,173,85,.35)', text:'#f6ad55', icon:'💬'},   // Discours
  {bg:'rgba(247,107,107,.12)', border:'rgba(247,107,107,.35)', text:'#f76b6b', icon:'😐'},// Affect
  {bg:'rgba(56,178,172,.12)', border:'rgba(56,178,172,.35)', text:'#38b2ac', icon:'🧠'},   // Cognition
  {bg:'rgba(159,122,234,.12)', border:'rgba(159,122,234,.35)', text:'#9f7aea', icon:'💡'}, // Pensée
  {bg:'rgba(237,137,54,.12)', border:'rgba(237,137,54,.35)', text:'#ed8936', icon:'👥'},   // Relation
];
const PRES_CONFIG = [
